...
Source0  : https://github.com/openSUSE/libeconf/archive/v0.7.3/libeconf-0.7.3.tar.gz
...
%prep
%setup -q -n libeconf-0.7.3
cd %{_builddir}/libeconf-0.7.3
pushd ..
cp -a libeconf-0.7.3 build32
popd
pushd ..
cp -a libeconf-0.7.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726668112
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libeconf.so.0.7.3
/usr/lib64/libeconf.so.0
/usr/lib64/libeconf.so.0.7.3

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libeconf.so.0
/usr/lib32/libeconf.so.0.7.3
