...
Version  : 0.6.2
Release  : 21
URL      : https://github.com/openSUSE/libeconf/archive/v0.6.2/libeconf-0.6.2.tar.gz
Source0  : https://github.com/openSUSE/libeconf/archive/v0.6.2/libeconf-0.6.2.tar.gz
...
%prep
%setup -q -n libeconf-0.6.2
cd %{_builddir}/libeconf-0.6.2
pushd ..
cp -a libeconf-0.6.2 build32
popd
pushd ..
cp -a libeconf-0.6.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709737732
