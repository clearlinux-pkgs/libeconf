...
Version  : 0.4.9
Release  : 12
URL      : https://github.com/openSUSE/libeconf/archive/v0.4.9/libeconf-0.4.9.tar.gz
Source0  : https://github.com/openSUSE/libeconf/archive/v0.4.9/libeconf-0.4.9.tar.gz
...
%prep
%setup -q -n libeconf-0.4.9
cd %{_builddir}/libeconf-0.4.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669220337
