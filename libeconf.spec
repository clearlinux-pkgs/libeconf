...
Version  : 0.3.3
Release  : 5
URL      : https://github.com/openSUSE/libeconf/archive/v0.3.3/libeconf-0.3.3.tar.gz
Source0  : https://github.com/openSUSE/libeconf/archive/v0.3.3/libeconf-0.3.3.tar.gz
Summary  : TODO
...
%prep
%setup -q -n libeconf-0.3.3
cd %{_builddir}/libeconf-0.3.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573533828
...
cp %{_builddir}/libeconf-0.3.3/LICENSE %{buildroot}/usr/share/package-licenses/libeconf/fcc7730890cf59ca8a39456c72a6d63c599094d9
%make_install
