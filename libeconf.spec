...
Version  : 0.4.4
Release  : 7
URL      : https://github.com/openSUSE/libeconf/archive/v0.4.4/libeconf-0.4.4.tar.gz
Source0  : https://github.com/openSUSE/libeconf/archive/v0.4.4/libeconf-0.4.4.tar.gz
...
%prep
%setup -q -n libeconf-0.4.4
cd %{_builddir}/libeconf-0.4.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645568156
...
cp %{_builddir}/libeconf-0.4.4/LICENSE %{buildroot}/usr/share/package-licenses/libeconf/fcc7730890cf59ca8a39456c72a6d63c599094d9
