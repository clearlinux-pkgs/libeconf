...
Version  : 0.4.8
Release  : 11
URL      : https://github.com/openSUSE/libeconf/archive/v0.4.8/libeconf-0.4.8.tar.gz
Source0  : https://github.com/openSUSE/libeconf/archive/v0.4.8/libeconf-0.4.8.tar.gz
...
%prep
%setup -q -n libeconf-0.4.8
cd %{_builddir}/libeconf-0.4.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668451334
