...
Version  : 0.4.5
Release  : 8
URL      : https://github.com/openSUSE/libeconf/archive/v0.4.5/libeconf-0.4.5.tar.gz
Source0  : https://github.com/openSUSE/libeconf/archive/v0.4.5/libeconf-0.4.5.tar.gz
...
%prep
%setup -q -n libeconf-0.4.5
cd %{_builddir}/libeconf-0.4.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649268659
...
cp %{_builddir}/libeconf-0.4.5/LICENSE %{buildroot}/usr/share/package-licenses/libeconf/fcc7730890cf59ca8a39456c72a6d63c599094d9
