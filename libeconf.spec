...
Source0  : https://github.com/openSUSE/libeconf/archive/v0.4.6/libeconf-0.4.6.tar.gz
...
%prep
%setup -q -n libeconf-0.4.6
cd %{_builddir}/libeconf-0.4.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651600498
...
cp %{_builddir}/libeconf-0.4.6/LICENSE %{buildroot}/usr/share/package-licenses/libeconf/fcc7730890cf59ca8a39456c72a6d63c599094d9
