...
Version  : 0.6.1
Release  : 20
URL      : https://github.com/openSUSE/libeconf/archive/v0.6.1/libeconf-0.6.1.tar.gz
Source0  : https://github.com/openSUSE/libeconf/archive/v0.6.1/libeconf-0.6.1.tar.gz
...
%prep
%setup -q -n libeconf-0.6.1
cd %{_builddir}/libeconf-0.6.1
pushd ..
cp -a libeconf-0.6.1 build32
popd
pushd ..
cp -a libeconf-0.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705935044
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libeconf.so.0.6.1
/usr/lib64/libeconf.so.0
/usr/lib64/libeconf.so.0.6.1

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libeconf.so.0
/usr/lib32/libeconf.so.0.6.1
