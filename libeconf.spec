...
Version  : 0.5.0
Release  : 13
URL      : https://github.com/openSUSE/libeconf/archive/v0.5.0/libeconf-0.5.0.tar.gz
Source0  : https://github.com/openSUSE/libeconf/archive/v0.5.0/libeconf-0.5.0.tar.gz
...
%prep
%setup -q -n libeconf-0.5.0
cd %{_builddir}/libeconf-0.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670490261
