...
Source0  : https://github.com/openSUSE/libeconf/archive/v0.7.0/libeconf-0.7.0.tar.gz
...
%prep
%setup -q -n libeconf-0.7.0
cd %{_builddir}/libeconf-0.7.0
pushd ..
cp -a libeconf-0.7.0 build32
popd
pushd ..
cp -a libeconf-0.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717509064
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libeconf.so.0.7.0
/usr/lib64/libeconf.so.0
/usr/lib64/libeconf.so.0.7.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libeconf.so.0
/usr/lib32/libeconf.so.0.7.0
